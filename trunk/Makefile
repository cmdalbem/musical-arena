...
CC = g++
FLAGS = -Wall -I"/usr/include" -I"irrlicht-1.7.1/include" -I"fmod/api/inc" -I"lib/tree-2.65/src" -I"nodes" -DHAVE_FMOD
...
OBJDIR = obj
OBJNAMES = Decoder utils Stone Fretting Track Player Screen Skill EventReceiver CBoltSceneNode TrackSceneNode CBloodEffect CBloodShader VxHealthSceneNode
