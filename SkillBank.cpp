...
void SkillBank::makeSkills()
{
	...
	}*/
	{
		...
		Skill s("Sunbirth", ATTACK, S_BIG, 200, FIRE, e, 2, EFFECT_SUN, k, 16, 5,
		"");
		skills[SUNBIRTH] = s;
	}
	{
		...
		Skill s("Explosion", ATTACK, S_EXPLOSION, 250, FIRE, e, 2, EFFECT_EXPLOSION, k, 8, 8,
	...
	/////////////////////////////
	{
		...
		Skill s("Lightning Bolt", ATTACK, S_LIGHTNING, 50, THUNDER, e, 3, EFFECT_BOLT, k, 4, 2,
	...
	}
	{
		...
		Skill s("Eletrified Ground", ATTACK, S_BOLT2, 130, THUNDER, e, 1, EFFECT_ELETRIC_GROUND, k, 14, 4,
	...
	}
	{
		...
		effectStruct e[] = {{T_DAMAGE, 170, -1},{T_ELETRIFY, 8, 0.05},{T_SPEED_UP, 8, -1}};
		Skill s("Thunder Storm", ATTACK, S_STORM, 270, THUNDER, e, 3, EFFECT_THUNDERSTORM, k, 12, 8,
	...
	}
	{
		...
		Skill s("Ball Lightning", ATTACK, S_ELECTRIC1, 110, THUNDER, e, 1, EFFECT_BALL_LIGHTNING, k, 6, 7,
	...
	/////////////////////////////	
	{
		...
		effectStruct e[] = {{T_HEAL, 100, -1},{T_ANTIDOTE, -1, -1},{T_DEFENSE_UP, 2, -1}};
		Skill s("Inspiration", DEFENSE, S_MAGIC1, 70, SPIRITUAL, e, 3, EFFECT_GLOW_AREA, k, 8, 2,
		"Cures all illness of the body and soul.");
	...
	}
	{
		...
		Skill s("Mirror", DEFENSE, S_DIGITAL, 120, SPIRITUAL, e, 2, EFFECT_SHIELD, k, 15, 4,
	...
	}
	{
		...
		Skill s("Divine Silence", DEFENSE, S_FIRERUMBLE, 160, SPIRITUAL, e, 2, EFFECT_SILENCE, k, 5, 6,
		"...");
	...
	}
	{
		...
		Skill s("Aurora", DEFENSE, S_MAGIC1, 270, SPIRITUAL, e, 2, EFFECT_AURORA, k, 6, 7,
		"A beautifull bless.");
		skills[AURORA] = s;
	}
	...
	/////////////////////////////	
	{
		...
		Skill s("Soul Corruption", ATTACK, S_HORROR1, 90, DARK, e, 1, EFFECT_BLACKHOLE, k, 10, 3,
		"");
	...
	}
	{
		...
		Skill s("Feedback", ATTACK, S_MAGIC2, 170, DARK, e, 1, EFFECT_FEEDBACK, k, 7, 5,
	...
	}
	{
		...
		Skill s("Vampiric", ATTACK, S_HORROR2, 90, DARK, e, 1, EFFECT_VAMPIRIC, k, 11, 4,
		"");
		skills[VAMPIRIC] = s;
	}	
	/*{
	...
	}	*/	
	{
		...
		effectStruct e[] = {{T_STAMINA_UP, 100, -1}};
		Skill s("Black Lotus", DEFENSE, S_MAGIC1, 0, DARK, e, 1, EFFECT_LOTUS, k, 19, 4,
		"The favorite of Darth Vader's bride.");
	...
	/////////////////////////////
	{
		...
		effectStruct e[] = {{T_DAMAGE, 30, -1},{T_STAMINA_DOWN, 40, -1},{T_DROWN, 3, -1}};
		Skill s("Water Beam", ATTACK, S_STREAM2, 50, WATER, e, 3, EFFECT_WATER_BEAM, k, 3, 2,
	...
	}
	{
		...
		Skill s("Flood", ATTACK, S_STREAM3, 150, WATER, e, 1, EFFECT_FLOOD, k, 15, 4,
	...
	}	
	{
		...
		Skill s("Swamp", ATTACK, S_UNDERWATER1, 120, WATER, e, 2, EFFECT_SWAMP, k, 10, 5,
	...
	}
	{
		...
		Skill s("Siberian", ATTACK, S_ICE1, 120, WATER, e, 1, EFFECT_FREEZE, k, 8, 7,
		"");
		skills[SIBERIAN] = s;
	}	
