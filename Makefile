...
OBJDIR = obj
OBJNAMES = Decoder utils Stone Fretting Track Player Screen Skill EventReceiver CBoltSceneNode TrackSceneNode CBloodEffect CBloodShader VxHealthSceneNode CShieldManager SkillBank EffectFactory SoundBank Instrument
